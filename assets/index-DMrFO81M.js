const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-Cb_uwIeD.js","./index-CUEpFBZo.js","./index-g_cLYwVj.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CUEpFBZo.js";
const t = Symbol();
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-Cb_uwIeD.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
