const __vite__fileDeps=["./index-Bvp3Pp5r.js","./index-B2F9b3rW.js","./index-Dso1Hl_w.css"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
import { _ as __vitePreload } from "./index-B2F9b3rW.js";
const t = Symbol();
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-Bvp3Pp5r.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
