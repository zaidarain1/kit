const __vite__fileDeps=["./index-Br1ln1tf.js","./index-CsHzCx6e.js","./index-B7cGsFOk.css"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
import { _ as __vitePreload } from "./index-CsHzCx6e.js";
const t = Symbol();
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-Br1ln1tf.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
