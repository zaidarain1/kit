const __vite__fileDeps=["./index-Ch6TF1T3.js","./index-C52aQQpt.js","./index-KxIcnz1U.css"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
import { _ as __vitePreload } from "./index-C52aQQpt.js";
const t = Symbol();
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-Ch6TF1T3.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
