const __vite__fileDeps=["./index-DI-D3Eqa.js","./index-BIBs7AbM.js","./index-KxIcnz1U.css"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
import { _ as __vitePreload } from "./index-BIBs7AbM.js";
const t = Symbol();
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-DI-D3Eqa.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
