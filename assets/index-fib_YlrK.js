const __vite__fileDeps=["./index-un5ivzXX.js","./index-BbeO2XvD.js","./index-Dso1Hl_w.css"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
import { _ as __vitePreload } from "./index-BbeO2XvD.js";
const t = Symbol();
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-un5ivzXX.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
