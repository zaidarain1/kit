const __vite__fileDeps=["./index-S6kmQPyx.js","./index-w7X5J-3q.js","./index-KxIcnz1U.css"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
import { _ as __vitePreload } from "./index-w7X5J-3q.js";
const t = Symbol();
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-S6kmQPyx.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
