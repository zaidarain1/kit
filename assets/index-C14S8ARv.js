const __vite__fileDeps=["./index-83y9qUZO.js","./index-DCygkcku.js","./index-KxIcnz1U.css"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
import { _ as __vitePreload } from "./index-DCygkcku.js";
const t = Symbol();
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-83y9qUZO.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
