const __vite__fileDeps=["./index-VmyWZKUM.js","./index-DxG9EmR1.js","./index-D8GxdXsk.css"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
import { p as process$1, r as require$$0$2, g as global, B as Buffer, a as getAugmentedNamespace, b as getDefaultExportFromCjs, c as commonjsGlobal, _ as __vitePreload } from "./index-DxG9EmR1.js";
import { r as require$$1, e as eventsExports, U as Ug } from "./___vite-browser-external_commonjs-proxy-WJJecfBs.js";
...
class v2 {
  ...
  async initialize(t) {
    if (this.rpc = this.getRpcConfig(t), this.chainId = this.rpc.chains.length ? g2(this.rpc.chains) : g2(this.rpc.optionalChains), this.signer = await hv.init({ projectId: this.rpc.projectId, metadata: this.rpc.metadata, disableProviderPing: t.disableProviderPing, relayUrl: t.relayUrl, storageOptions: t.storageOptions }), this.registerEventListeners(), await this.loadPersistedSession(), this.rpc.showQrModal) {
      let s;
      try {
        const { WalletConnectModal: i2 } = await __vitePreload(() => import("./index-VmyWZKUM.js").then((n3) => n3.i), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
        s = i2;
      } catch {
