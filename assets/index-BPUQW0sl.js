const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-CTemPPoy.js","./index-CHAbHKEn.js","./index-g_cLYwVj.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CHAbHKEn.js";
const t = Symbol();
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-CTemPPoy.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
