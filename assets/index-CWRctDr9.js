const __vite__fileDeps=["./index-Cm51OdWP.js","./index-CxBFk7Wx.js","./index-D-Tlm5BR.css"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
import { _ as __vitePreload } from "./index-CxBFk7Wx.js";
const t = Symbol();
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-Cm51OdWP.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
