const __vite__fileDeps=["./index-CM-yixrg.js","./index-B_h-MKbm.js","./index-D8GxdXsk.css"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
import { _ as __vitePreload } from "./index-B_h-MKbm.js";
const t = Symbol();
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-CM-yixrg.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
