import { c as commonjsGlobal, b as bnExports, B as Buffer$7, r as require$$2$1, i as inherits_browserExports, g as getAugmentedNamespace, p as process$1, t as tslib_es6, e as eventemitter3Exports, a as getDefaultExportFromCjs } from "./index-CntkoWfR.js";
import { e as eventsExports, r as require$$1$2 } from "./___vite-browser-external_commonjs-proxy-BlcACipu.js";
...
var LinkFlow$1 = {};
var n, l$1, u$1, t$3, i$2, o$1, r$2, f$1, e$1, c$1 = {}, s$1 = [], a$1 = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, h$1 = Array.isArray;
function v$1(n2, l2) {
  for (var u2 in l2)
    n2[u2] = l2[u2];
  return n2;
...
function w$1(n2, u2, t2) {
  var i, o2 = n2.__v, r2 = o2.__e, f2 = n2.__P;
  if (f2)
    return (i = v$1({}, o2)).__v = o2.__v + 1, l$1.vnode && l$1.vnode(i), M(f2, i, o2, n2.__n, void 0 !== f2.ownerSVGElement, 32 & o2.__u ? [r2] : null, u2, null == r2 ? m$1(o2) : r2, !!(32 & o2.__u), t2), i.__.__k[i.__i] = i, i.__d = void 0, i.__e != r2 && k$1(i), i;
}
function k$1(n2) {
  var l2, u2;
...
function x$1(n2) {
  (!n2.__d && (n2.__d = true) && i$2.push(n2) && !C$1.__r++ || o$1 !== l$1.debounceRendering) && ((o$1 = l$1.debounceRendering) || r$2)(C$1);
}
function C$1() {
  var n2, u2, t2, o2 = [], r2 = [];
  for (i$2.sort(f$1); n2 = i$2.shift(); )
    n2.__d && (t2 = i$2.length, u2 = w$1(n2, o2, r2) || u2, 0 === t2 || i$2.length > t2 ? (j$1(o2, u2, r2), r2.length = o2.length = 0, u2 = void 0, i$2.sort(f$1)) : u2 && l$1.__c && l$1.__c(u2, s$1));
  u2 && j$1(o2, u2, r2), C$1.__r = 0;
}
function P$1(n2, l2, u2, t2, i, o2, r2, f2, e2, a2, h2) {
  var v2, p2, y2, d2, _2, g2 = t2 && t2.__k || s$1, b2 = l2.length;
  for (u2.__d = e2, S(u2, l2, g2), e2 = u2.__d, v2 = 0; v2 < b2; v2++)
    null != (y2 = u2.__k[v2]) && "boolean" != typeof y2 && "function" != typeof y2 && (p2 = -1 === y2.__i ? c$1 : g2[y2.__i] || c$1, y2.__i = v2, M(n2, y2, p2, i, o2, r2, f2, e2, a2, h2), d2 = y2.__e, y2.ref && p2.ref != y2.ref && (p2.ref && N(p2.ref, null, y2), h2.push(y2.ref, y2.__c || d2, y2)), null == _2 && null != d2 && (_2 = d2), 65536 & y2.__u || p2.__k === y2.__k ? e2 = $(y2, e2, n2) : "function" == typeof y2.type && void 0 !== y2.__d ? e2 = y2.__d : d2 && (e2 = d2.nextSibling), y2.__d = void 0, y2.__u &= -196609);
  u2.__d = e2, u2.__e = _2;
}
function S(n2, l2, u2) {
  var t2, i, o2, r2, f2, e2 = l2.length, c2 = u2.length, s2 = c2, a2 = 0;
  for (n2.__k = [], t2 = 0; t2 < e2; t2++)
    null != (i = n2.__k[t2] = null == (i = l2[t2]) || "boolean" == typeof i || "function" == typeof i ? null : "string" == typeof i || "number" == typeof i || "bigint" == typeof i || i.constructor == String ? d$1(null, i, null, null, i) : h$1(i) ? d$1(g$1, { children: i }, null, null, null) : void 0 === i.constructor && i.__b > 0 ? d$1(i.type, i.props, i.key, i.ref ? i.ref : null, i.__v) : i) ? (i.__ = n2, i.__b = n2.__b + 1, f2 = I(i, u2, r2 = t2 + a2, s2), i.__i = f2, o2 = null, -1 !== f2 && (s2--, (o2 = u2[f2]) && (o2.__u |= 131072)), null == o2 || null === o2.__v ? (-1 == f2 && a2--, "function" != typeof i.type && (i.__u |= 65536)) : f2 !== r2 && (f2 === r2 + 1 ? a2++ : f2 > r2 ? s2 > e2 - r2 ? a2 += f2 - r2 : a2-- : a2 = f2 < r2 && f2 == r2 - 1 ? f2 - r2 : 0, f2 !== t2 + a2 && (i.__u |= 65536))) : (o2 = u2[t2]) && null == o2.key && o2.__e && (o2.__e == n2.__d && (n2.__d = m$1(o2)), O(o2, o2, false), u2[t2] = null, s2--);
  if (s2)
    for (t2 = 0; t2 < c2; t2++)
      null != (o2 = u2[t2]) && 0 == (131072 & o2.__u) && (o2.__e == n2.__d && (n2.__d = m$1(o2)), O(o2, o2));
}
function $(n2, l2, u2) {
  var t2, i;
  if ("function" == typeof n2.type) {
    for (t2 = n2.__k, i = 0; t2 && i < t2.length; i++)
      t2[i] && (t2[i].__ = n2, l2 = $(t2[i], l2, u2));
    return l2;
  }
...
function M(n2, u2, t2, i, o2, r2, f2, e2, c2, s2) {
  ...
  n:
    if ("function" == typeof A2)
      try {
        if (k2 = u2.props, x2 = (a2 = A2.contextType) && i[a2.__c], C2 = a2 ? x2 ? x2.props.value : a2.__ : i, t2.__c ? w2 = (p2 = u2.__c = t2.__c).__ = p2.__E : ("prototype" in A2 && A2.prototype.render ? u2.__c = p2 = new A2(k2, C2) : (u2.__c = p2 = new b$1(k2, C2), p2.constructor = A2, p2.render = q$1), x2 && x2.sub(p2), p2.props = k2, p2.state || (p2.state = {}), p2.context = C2, p2.__n = i, y2 = p2.__d = true, p2.__h = [], p2._sb = []), null == p2.__s && (p2.__s = p2.state), null != A2.getDerivedStateFromProps && (p2.__s == p2.state && (p2.__s = v$1({}, p2.__s)), v$1(p2.__s, A2.getDerivedStateFromProps(k2, p2.__s))), d2 = p2.props, _2 = p2.state, p2.__v = u2, y2)
        ...
        if (p2.context = C2, p2.props = k2, p2.__P = n2, p2.__e = false, $2 = l$1.__r, H2 = 0, "prototype" in A2 && A2.prototype.render) {
        ...
        p2.state = p2.__s, null != p2.getChildContext && (i = v$1(v$1({}, i), p2.getChildContext())), y2 || null == p2.getSnapshotBeforeUpdate || (m2 = p2.getSnapshotBeforeUpdate(d2, _2)), P$1(n2, h$1(T2 = null != a2 && a2.type === g$1 && null == a2.key ? a2.props.children : a2) ? T2 : [T2], u2, t2, i, o2, r2, f2, e2, c2, s2), p2.base = u2.__e, u2.__u &= -161, p2.__h.length && f2.push(p2), w2 && (p2.__E = p2.__ = null);
      } catch (n3) {
...
function z$1(l2, u2, t2, i, o2, r2, f2, e2, s2) {
  ...
  if (null === x2)
    ...
    if (r2 = r2 && n.call(l2.childNodes), w2 = t2.props || c$1, !e2 && null != r2)
    ...
    for (a2 in k2)
      _2 = k2[a2], "children" == a2 ? d2 = _2 : "dangerouslySetInnerHTML" == a2 ? v2 = _2 : "value" == a2 ? g2 = _2 : "checked" == a2 ? b2 = _2 : "key" === a2 || e2 && "function" != typeof _2 || w2[a2] === _2 || A$1(l2, a2, _2, w2[a2], o2);
    if (v2)
      e2 || y2 && (v2.__html === y2.__html || v2.__html === l2.innerHTML) || (l2.innerHTML = v2.__html), u2.__k = [];
    else if (y2 && (l2.innerHTML = ""), P$1(l2, h$1(d2) ? d2 : [d2], u2, t2, i, o2 && "foreignObject" !== x2, r2, f2, r2 ? r2[0] : t2.__k && m$1(t2, 0), e2, s2), null != r2)
      for (a2 = r2.length; a2--; )
...
function O(n2, u2, t2) {
  ...
  if (i = n2.__k)
    for (o2 = 0; o2 < i.length; o2++)
      i[o2] && O(i[o2], u2, t2 || "function" != typeof n2.type);
...
function B$1(u2, t2, i) {
  var o2, r2, f2, e2;
  l$1.__ && l$1.__(u2, t2), r2 = (o2 = "function" == typeof i) ? null : i && i.__k || t2.__k, f2 = [], e2 = [], M(t2, u2 = (!o2 && i || t2).__k = y$1(g$1, null, [u2]), r2 || c$1, c$1, void 0 !== t2.ownerSVGElement, !o2 && i ? [i] : r2 ? null : t2.firstChild ? n.call(t2.childNodes) : null, f2, !o2 && i ? i : r2 ? r2.__e : t2.firstChild, o2, e2), u2.__d = void 0, j$1(f2, u2, e2);
}
function E(n2, l2) {
  B$1(n2, l2, E);
}
function F$1(l2, u2, t2) {
...
}, b$1.prototype.render = g$1, i$2 = [], r$2 = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, f$1 = function(n2, l2) {
...
const SafeEventEmitter3 = safeEventEmitter$1.default;
