const __vite__fileDeps=["./index-h3WCoqgS.js","./index--unRzoqU.js","./index-DRneY2rd.css"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
import { _ as __vitePreload } from "./index--unRzoqU.js";
const t = Symbol();
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-h3WCoqgS.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
