const __vite__fileDeps=["./index-D-dkdeKn.js","./index-QiBhLgsY.js","./index-KxIcnz1U.css"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
import { _ as __vitePreload } from "./index-QiBhLgsY.js";
const t = Symbol();
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-D-dkdeKn.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
