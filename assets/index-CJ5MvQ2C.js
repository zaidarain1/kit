const __vite__fileDeps=["./index-Bbl90F7t.js","./index-BUNEaHbj.js","./index-BY3QI6Mi.css"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
import { _ as __vitePreload } from "./index-BUNEaHbj.js";
const t = Symbol();
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-Bbl90F7t.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
