const __vite__fileDeps=["./index-DzVkZDWS.js","./index-dY-7UIE-.js","./index-DRneY2rd.css"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
import { _ as __vitePreload } from "./index-dY-7UIE-.js";
const t = Symbol();
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-DzVkZDWS.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
